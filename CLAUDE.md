...
```bash
clang++ -std=c++17 -g -Wall -Wextra *.cpp fonts/*.cpp \
  -o lilos -I/opt/homebrew/opt/sdl2/include -I. \
  -L/opt/homebrew/opt/sdl2/lib -lSDL2 && ./lilos
```

> ⚠️ This is not yet codified in a build file. Replacing it with CMake is issue #1.
> Until then, verify any change compiles with the command above before claiming it works.

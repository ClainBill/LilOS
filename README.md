...
In its current state we only have a few simple shape renderers and a text renderer that both draw to a framebuffer to be drawn. The framebuffer in its current state is pusged to an SDL2 window.
